...
const experience = [
  ...
  },
  {
    ...
    description: (
      <ul className="list-disc">
        <li>
          Completed a MERN Stack Bootcamp at Softoo, gaining practical
          experience in building full-stack applications with MongoDB,
          Express.js, React, and Node.js
        </li>
        <li>
          Developed a web app to connect patients with doctors for online
          appointments
        </li>
        <li>
          Implemented features for booking, rescheduling, and managing
          appointments. Integrated secure communication channels and real- time
  ...
  },
  {
    ...
    description: (
      <ul className="list-disc">
        <li>
          Delivered a variety of mobile development projects, meeting diverse
          client requirements and expectations.
        </li>
        <li>
          Worked extensively with React, and vanilla JavaScript to develop
